...
/**
 * Rendering products as cards in the product-list container
 * @param {Array} products - i.e. array of product objects to render
 */
...
sortPriceBtn.addEventListener("click", () => {
  isSorted = !isSorted; // Toggling sort state
